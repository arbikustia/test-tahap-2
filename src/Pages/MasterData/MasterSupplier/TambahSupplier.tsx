            ...
            <div className="w-full grid h-fit overflow-auto bg-white-50 rounded-xl p-3 my-5">
                ...
                <div className=" w-full h-fit">
                    <div className=' flex flex-col row-span-1 py-4 gap-4 h-fit text-3xl'>
                        <span className='font-extrabold'>Tambah Supplier</span>
                    </div>
                    <div className=''>
                        <Form
                            form={form}
                            ...
                            <div className=" h-fit w-full grid grid-cols-2 gap-x-10 pt-3">
                                <div className="">
                                    ...
                                    <Form.Item
                                        ...
                                        name="id_supplier"
                                        className='text-xl'
                                        rules={[{ required: false, message: 'Mohon Masukan ID Supplier!' }]}>
                                        <Input disabled type='number' size="large" className='h-14 w-full' placeholder='[Auto]' />
                                    </Form.Item>
                                    <Form.Item
                                        label="Nama Supplier"
                                        name="nama_supplier   "
                                        rules={[{ required: false, message: 'Mohon Masukan Nama Supplier!' }]}>
                                        <Input type='text' size="large" className='h-14 w-full' placeholder='Input Nama Supplier' />
                                    </Form.Item>
                                </div>
                            ...
                            <div className='w-full flex justify-end border-t border-dashed border-gray-300'>
                                <div className='flex justify-end py-5 text-blue-500 gap-5'>
                                    <button  className="font-bold rounded-md flex justify-center gap-2 items-center border border-blue-500  text-blue-500 w-48 h-12 " onClick={() => navigate('/master/supplier')}>
