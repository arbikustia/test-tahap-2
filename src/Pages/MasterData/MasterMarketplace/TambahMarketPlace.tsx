            ...
            <div className="w-full grid h-fit overflow-auto bg-white-50 rounded-xl p-3 my-5">
                ...
                <div className=" w-full h-fit">
                    <div className=' flex flex-col row-span-1 py-4 gap-4 h-fit text-3xl'>
                        <span className='font-extrabold'>Tambah Market Place</span>
                    </div>
                    <div className=''>
                        <Form
                            form={form}
                            ...
                            <div className=" h-fit w-full grid grid-cols-2 gap-x-10 pt-3">
                                <div className="">
                                    ...
                                    <Form.Item
                                        label="ID Market Place"
                                        name="id_market_place"
                                        className='text-xl'
                                        rules={[{ required: false, message: 'Mohon Masukan ID Market Place!' }]}>
                                        <Input disabled type='number' size="large" className='h-14 w-full' placeholder='[Auto]' />
                                    </Form.Item>
                                    <Form.Item
                                        label="Nama Market Place"
                                        name="nama_market_place   "
                                        rules={[{ required: false, message: 'Mohon Masukan Nama Market Place!' }]}>
                                        <Input type='text' size="large" className='h-14 w-full' placeholder='Input Nama market Place' />
                                    </Form.Item>
                                </div>
                            ...
                            <div className='w-full flex justify-end border-t border-dashed border-gray-300'>
                                <div className='flex justify-end py-5 text-blue-500 gap-5'>
                                    <button className="font-bold rounded-md flex justify-center gap-2 items-center border border-blue-500  text-blue-500 w-48 h-12 " onClick={() => navigate('/master/market-place')}>
...
export default TambahMarketPlace