            ...
            <div className="w-full grid h-fit overflow-auto bg-white-50 rounded-xl p-3 my-5">
                ...
                <div className=" w-full h-fit">
                    <div className=' flex flex-col row-span-1 py-4 gap-4 h-fit text-3xl'>
                        <span className='font-extrabold'>Tambah Lokasi</span>
                    </div>
                    <div className=''>
                        <Form
                            form={form}
                            ...
                            <div className=" h-fit w-full grid grid-cols-2 gap-x-10 pt-3">
                                <div className="">
                                    ...
                                    <Form.Item
                                        ...
                                        name="id_lokasi"
                                        className='text-xl'
                                        rules={[{ required: false, message: 'Mohon Masukan ID Lokasi!' }]}>
                                        <Input disabled type='number' size="large" className='h-14 w-full' placeholder='[Auto]' />
                                    </Form.Item>
                                    <Form.Item
                                        label="Nama Lokasi"
                                        name="nama_lokasi   "
                                        rules={[{ required: false, message: 'Mohon Masukan Nama Lokasi!' }]}>
                                        <Input type='text' size="large" className='h-14 w-full' placeholder='Input Nama Lokasi' />
                                    </Form.Item>
                                </div>
